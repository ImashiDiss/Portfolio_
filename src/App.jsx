...
const Navbar = () => (
  <nav className="fixed top-0 w-full bg-white/80 dark:bg-slate-900/90 backdrop-blur-sm z-50 border-b border-slate-200 dark:border-white/10 transition-colors duration-300">
    <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
      <h1 className="text-xl font-bold text-blue-600 dark:text-cyan-400 font-mono"></h1>
    ...
    <div className="text-center max-w-3xl">
      ...
      >
        ...
        <div className="flex justify-center gap-4">
          ...
          <a href={`https://mail.google.com/mail/?view=cm&to=${personalDetails.email}&subject=Hello&body=Hi%20Imashi,%0A%0AI%20would%20like%20to%20connect%20with%20you.`}
          target="_blank"
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-8 items-center">
        <div className="md:col-span-2 text-slate-600 dark:text-slate-300 leading-relaxed text-lg transition-colors">
          ...
          <p className="mb-4">
           My projects include retail sales forecasting, fashion trend prediction, and supermarket navigation analytics, demonstrating my ability to analyze complex datasets, generate insights, and support data-driven decision-making. Recently, I was ranked 14th at the SLIIT Xtreme 4.0 Hackathon, reflecting my analytical thinking and problem-solving skills in competitive environments.

          </p>
          <p className="mb-4">
          I am eager to contribute to data-driven teams and apply my skills to solve real-world business challenges through analytics and insight generation
  ...
  <section id="contact" className="py-20 px-4 text-center bg-slate-50 dark:bg-slate-800/50 transition-colors">
    <div className="max-w-2xl mx-auto">
      ...
      <p className="text-slate-600 dark:text-slate-400 text-lg mb-10">
       I am currently seeking an internship in Data Science and Business Analytics. Whether you have a question, an opportunity, or simply want to connect, I’ll do my best to get back to you.
      </p>
      <div className="flex justify-center gap-4">
        <a 
        ...
        <a 
          href={`https://mail.google.com/mail/?view=cm&to=${personalDetails.email}&subject=Hello&body=Hi%20Imashi,%0A%0AI%20would%20like%20to%20connect%20with%20you.`}
          target="_blank"
          rel="noopener noreferrer"
          className="px-8 py-4 border border-blue-600 dark:border-cyan-400 text-blue-600 dark:text-cyan-400 rounded hover:bg-blue-50 dark:hover:bg-cyan-400/10 transition font-mono font-medium"
        >
...
const Footer = () => (
  <footer className="py-8 text-center text-sm text-slate-500 dark:text-slate-400 font-mono bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-white/5 transition-colors">
    <p>Designed & Built by Imashi Dissanayake</p>
  </footer>
);
